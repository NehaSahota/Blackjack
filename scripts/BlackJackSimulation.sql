 ...
 ---------------------------------- ONE PLAYER GAME WITH DEALER --------------------------------------------------

 -- testing of one player game
 DECLARE
    card_number integer;
...
BEGIN 
sp_update_game_info (1, 2, SYSDATE , 0);
END;
 
 --****************TEST DELETE GAME INFO
 BEGIN 
sp_delete_game_info(1);
END;
 
--************TEST UPDATE GAME_PLAYER INFO
 
BEGIN 
sp_update_game_player_info (1,1,1,10);
END;
 
--*************TEST GET DRAWN CARDS HISTORY
 
BEGIN
sp_get_drawn_cards_history() ;
END

--*******************TEST UPDATE DRAWN CARDS HISTORY
BEGIN
sp_update_drawncards_history();
END

--********************TEST DELETE DRAWN CARDS HISTORY*
BEGIN 
...
--***********TEST DELETE DATA FROM ALL TABLES
